const goblins = {
  ...
  15: {
    ...
    animations: {
      ...
      death:
        "https://res.cloudinary.com/ddguqr8l8/image/upload/v1733180319/deathPistacho_uleifs.gif",
    },
  },
  16: {
    ...
    animations: {
      ...
      death:
        "https://res.cloudinary.com/ddguqr8l8/image/upload/v1733180320/deathPistachoYellow_czq6ob.gif",
    },
  },
  17: {
    color: "purple",
    animations: {
      ...
      death:
        "https://res.cloudinary.com/ddguqr8l8/image/upload/v1733180329/deathPurple_rcgwr0.gif",
    },
  },
  18: {
    color: "purple-yellow",
    animations: {
      ...
      death:
        "https://res.cloudinary.com/ddguqr8l8/image/upload/v1733180329/deathPurpleYellow_vurl2j.gif",
    },
  },
  19: {
    color: "red",
    animations: {
      ...
      death:
        "https://res.cloudinary.com/ddguqr8l8/image/upload/v1733180329/deathRed_juefxv.gif",
    },
  },
  20: {
    color: "red-yellow",
    animations: {
      ...
      death:
        "https://res.cloudinary.com/ddguqr8l8/image/upload/v1733180331/deathRedYellow_txotlf.gif",
    },
  },
};
...
export function showDuelingGoblins(player1, player2) {
  ...
  goblin1.setAttribute("id", "left-goblin");
...
export function showDyingGoblin(player, inverted) {
  function urlDyingGoblinAnimation(player) {
    return goblins[assignedGoblins.get(player)].animations.death;
  }

  if (inverted) {
    document.getElementById("right-goblin").src =
    urlDyingGoblinAnimation(player);
  } else {
    document.getElementById("left-goblin").src =
      urlDyingGoblinAnimation(player);
  }
}
